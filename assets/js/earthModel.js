...
Earth.createEarth = function() {
    ...
    material = new THREE.MeshPhongMaterial({
        map: THREE.ImageUtils.loadTexture(Earth.baseURL + 'earthModel/assets/images/earthmap1k.jpg'),
        bumpMap: THREE.ImageUtils.loadTexture(Earth.baseURL + 'earthModel/assets/images/earthbump1k.jpg'),
        bumpScale: 0.05,
        specularMap: THREE.ImageUtils.loadTexture(Earth.baseURL + 'earthModel/assets/images/earthspec1k.jpg'),
...
Earth.createEarthCloud = function() {
    ...
    imageMap.addEventListener("load", function() {
        ...
        imageTrans.src = Earth.baseURL + 'earthModel/assets/images/earthcloudmaptrans.jpg';
    }, false);
    imageMap.src = Earth.baseURL + 'earthModel/assets/images/earthcloudmap.jpg';
